...
public class QMSRoleDO {
     ...
     * 角色名称
     */
    @LogTag(alias = "roleName", builtinType = BuiltinTypeHandler.NORMAL)
     ...
     *
     */
    @LogTag(alias = "allowUpload", builtinType = BuiltinTypeHandler.NORMAL)
    private Boolean allowUpload;
    /**
     * 允许下载 true - 是 false - 否
     */
    @LogTag(alias = "allowDown", builtinType = BuiltinTypeHandler.NORMAL)
    private Boolean allowDown;
    /**
     * 允许审核 true - 是 false - 否
     */
    @LogTag(alias = "allowAudit", builtinType = BuiltinTypeHandler.NORMAL)
    private Boolean allowAudit;
    /**
     * 允许审批 true - 是 false - 否
     */
    @LogTag(alias = "allowApprove", builtinType = BuiltinTypeHandler.NORMAL)
    private Boolean allowApprove;
    /**
     * 允许接受 true - 是 false - 否
     */
    @LogTag(alias = "allowReceive", builtinType = BuiltinTypeHandler.NORMAL)
    private Boolean allowReceive;
    /**
     * 允许授权 true - 是 false - 否
     */
    @LogTag(alias = "allowAuthorization", builtinType = BuiltinTypeHandler.NORMAL)
    private Boolean allowAuthorization;
    /**
     * 允许打印 true - 是 false - 否
     */
    @LogTag(alias = "allowPrint", builtinType = BuiltinTypeHandler.NORMAL)
    private Boolean allowPrint;
    /**
     * 允许归档 true - 是 false - 否
     */
    @LogTag(alias = "allowArchive", builtinType = BuiltinTypeHandler.NORMAL)
    private Boolean allowArchive;
    /**
     * 允许配置 true - 是 false - 否
     */
    @LogTag(alias = "allowConfigure", builtinType = BuiltinTypeHandler.NORMAL)
     ...
     * 年审 true - 是 false - 否
     */
    @LogTag(alias = "allowYear", builtinType = BuiltinTypeHandler.NORMAL)
    private Boolean allowYear;
    /**
     * 仪器设置/授权 true - 是 false - 否
     */
    @LogTag(alias = "allowDevice", builtinType = BuiltinTypeHandler.NORMAL)
    private Boolean allowDevice;
    /**
     * 允许下载源文件 true - 是 false - 否
     */
    @LogTag(alias = "allowDownSourceFile", builtinType = BuiltinTypeHandler.NORMAL)
